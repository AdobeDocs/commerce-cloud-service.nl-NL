...
>[!NOTE]
>
>Op een Pro Staging/de cluster van de Productie die drie knopen (of drie de dienstknopen op [ Geschaalde Architectuur ](https://experienceleague.adobe.com/en/docs/commerce-cloud-service/user-guide/architecture/scaled-architecture#service-tier) heeft, zou `indices_settings` als volgt moeten worden geplaatst:
>
>```yaml
>           indices_settings:
>               number_of_shards: 3
