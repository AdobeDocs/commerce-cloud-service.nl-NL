...
- [ Veilige configuratie voor geloofsbrieven Admin en Basis Admin URL ](https://docs.magento.com/user-guide/stores/security-admin.html)
...
- [ Veilige configuratie voor Admin gebruiker ](https://docs.magento.com/user-guide/stores/security-admin.html)

- [ Veilige configuratie voor Admin URL ](https://docs.magento.com/user-guide/stores/store-urls-custom-admin.html)
...
- [ vorm twee-factor authentificatie ](https://devdocs.magento.com/guides/v2.4/security/two-factor-authentication.html)
