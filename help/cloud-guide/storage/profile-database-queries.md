---
title: Databasequery's profiel
description: Leer hoe u profilering kunt inschakelen om inzicht te krijgen in de gevolgen van wijzigingen in de database.
...
1. Geef het logboek met query&#39;s weer.

   ```sql
   SHOW profiles
   ```

1. De profielwachtrij wissen.
